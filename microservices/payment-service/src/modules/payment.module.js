...
var kafka_module_1 = require('../config/kafka.module');
    ...
    (0, common_1.Module)({
      imports: [
        typeorm_1.TypeOrmModule.forFeature([
          entities_1.Payment,
          entities_1.PaymentMethod,
          entities_1.Refund,
        ]),
        kafka_module_1.KafkaModule,
      ],
      controllers: [controllers_1.PaymentController],
      providers: [services_1.PaymentService, services_1.StripeService],
      exports: [services_1.PaymentService, services_1.StripeService],
    }),
  ];
